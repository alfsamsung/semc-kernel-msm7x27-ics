...
#define CONFIG_FB_MSM_MDDI_TOSHIBA_HVGA_LCD 1
...
#define CONFIG_MD 1
#define CONFIG_LOCALVERSION "$(KERNEL_LOCAL_VERSION)-Alfs"
...
#define CONFIG_MACH_MSM7X27_SHAKIRA 1
...
#define CONFIG_CMDLINE "mem=222M androidboot.hardware=delta console=ttyMSM2"
